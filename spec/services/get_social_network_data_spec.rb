...
RSpec.describe GetSocialNetworkData do
  ...
  context 'valid api call' do
    ...
    before(:each) do
      stub_request(:get, GetSocialNetworkData::TWITTER_URL)
        .to_return(body: twitter_response.to_json)

      stub_request(:get, GetSocialNetworkData::FACEBOOK_URL)
        .to_return(body: facebook_response.to_json)

      stub_request(:get, GetSocialNetworkData::INSTAGRAM_URL)
